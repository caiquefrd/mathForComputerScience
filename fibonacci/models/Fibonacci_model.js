...
var CalcFibonacci = /** @class */ (function () {
    function CalcFibonacci(initTerm, nInput) {
        this.initTerm = initTerm;
        this.nInput = nInput;
    }
    CalcFibonacci.prototype.Fibonacci = function (nPosition) {
        if (nPosition <= 1) {
